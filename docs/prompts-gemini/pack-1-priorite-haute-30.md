# Pack 1 — Priorité HAUTE : les 30 dernières variantes d'issue
...
Chaque image illustre l'ISSUE (bonne ou mauvaise) d'un événement déjà illustré.
...
- `result-beg-fleuriste-good.webp`
  Le Fleuriste, issue heureuse : "Des fleurs pour madame ?" Vous vendez 3 roses. 6€ !
...
- `result-legend-carton-bad.webp`
  Un vieux carton usé, relique d'une légende de la rue, sous un porche. Issue ratée : Le carton est vide mais le SDF repart inspiré, silhouette digne au couchant.
...
- `result-steal-poche-costard-good.webp`
  La Poche du Costard, issue heureuse : Vos doigts de fée font merveille. 15€ et il ronfle toujours.
- `result-steal-supermarche-good.webp`
  Le Supermarché, issue heureuse : Vous passez les portiques l'air de rien. Conserves et chocolat : repas assuré.
- `result-steal-velo-bad.webp`
  Le Vélo Mal Attaché, issue ratée : Le propriétaire surgit du café d'à côté. La poursuite tourne mal pour vous.
