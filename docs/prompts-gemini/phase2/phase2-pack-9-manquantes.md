...
4. **Génère UNIQUEMENT les deux fichiers de la liste.** Rien d'autre.
...
Après huit packs, il ne reste que **deux** images dans tout le jeu qui n'ont
pas leur illustration. Un audit complet vient de le confirmer : sur les 981
images que le code peut réclamer, 979 existent. Voici les deux dernières.

---

### 1. `intro-marchandage.webp`

**Où elle apparaît :** la carte « comment jouer » du mini-jeu de marchandage,
« Le Culot ». C'est la toute première chose qu'un joueur voit en découvrant
qu'on peut négocier les prix en boutique. Elle doit faire comprendre le jeu
...
eux, sur le comptoir, **une grande étiquette de prix en carton pendue à une
ficelle**, avec un chiffre raturé plusieurs fois et réécrit en dessous (des
gribouillis, pas de vrais chiffres lisibles). Derrière la commerçante, des
rayonnages de conserves et de pains en carton.

**Le gag :** l'étiquette a été raturée tellement de fois que le carton est
troué à force de gommer. Un petit tas de miettes de gomme sous le comptoir.

**Ambiance :** intérieur chaleureux, lumière de fin d'après-midi par la
vitrine, guirlande au-dessus de la caisse.

---

### 2. `result-sursaut-good.webp`
...
**Ambiance :** nuit bleue, une seule source de lumière chaude (la guirlande),
contraste doux. La composition doit respirer : beaucoup d'espace vide au-dessus
du personnage.
...
```
intro-marchandage.webp
result-sursaut-good.webp
```

Deux fichiers. Pas un de plus.
