...
Nouveau bloc de jeu : un prêteur sur gages aborde le personnage quand il est
...
quelqu'un qui a déjà entendu toutes les excuses.
...
> jamais le geste. Un carton qui a pris un coup est plus efficace qu'un poing
> levé, et c'est aussi ce que la direction artistique sait faire de mieux.
