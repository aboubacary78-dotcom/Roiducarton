...
const JOB_DOWNFALLS: Record<string, Bilingual[]> = {
  comptable: [
    { fr: "{name} a passé vingt ans à équilibrer les comptes des autres. Le jour où il a regardé les siens, il n'y avait plus rien à équilibrer.", en: "{name} spent twenty years balancing other people's books. The day he looked at his own, there was nothing left to balance." },
  ...
  ouvrier: [
    ...
    { fr: "{name} a réparé lui-même la machine qui devait le remplacer. Elle marche toujours ; lui, beaucoup moins.", en: "{name} personally repaired the machine that was meant to replace him. It still runs; he doesn't, so much." },
  ...
  professeur: [
    ...
    { fr: "{name} a donné ses derniers billets à un élève dans le besoin. Il a oublié d'en garder pour lui-même.", en: "{name} gave his last few bills to a student in need. He forgot to keep any for himself." },
  ],
  sommelier: [
    { fr: "{name} a servi du vinaigre à la place du grand cru, au dîner le plus important de sa carrière. Il jure encore que les deux avaient le même nez.", en: "{name} served vinegar instead of the fine vintage at the most important dinner of his career. He still swears the two smelled the same." },
    { fr: "{name} a goûté toute la cave, bouteille après bouteille, pour être bien sûr. Il en était sûr, et sans emploi.", en: "{name} tasted the whole cellar, bottle by bottle, just to be sure. He was sure, and out of a job." },
  ...
  cascadeur: [
    { fr: "{name} a survécu à mille cascades impossibles. Il s'est brisé le poignet en glissant sur un savon dans sa salle de bain.", en: "{name} survived a thousand impossible stunts. He broke his wrist slipping on a bar of soap in his own bathroom." },
    { fr: "{name} a doublé une star sur un pont en flammes. La production a fait faillite le lendemain, et lui avec.", en: "{name} doubled a star on a burning bridge. The production went bankrupt the next day, and he went with it." },
  ...
  informaticien: [
    ...
    { fr: "{name} a oublié le seul mot de passe qui comptait vraiment. Il le cherche encore.", en: "{name} forgot the one password that actually mattered. He is still looking for it." },
  ...
  cuisinier: [
    ...
    { fr: "{name} a transformé un rat en plat du jour cinq étoiles. Un inspecteur l'a vu attraper le rat.", en: "{name} turned a rat into a five-star special. An inspector saw him catch the rat." },
  ...
  infirmier: [
    { fr: "{name} a soigné toute la ville, sauf lui-même. Il l'a compris trop tard, devant sa porte, les clés restées à l'intérieur.", en: "{name} cared for the whole town, except himself. He realized too late, at his own door, keys still inside." },
    { fr: "{name} a donné son dernier billet à un patient pour un taxi. Il a fait tout le chemin du retour à pied.", en: "{name} gave his last bill to a patient for a cab. He walked the whole way home himself." },
    { fr: "{name} a couvert les gardes de tout le monde pendant des années. Le jour où il est tombé, il n'y avait personne pour lui.", en: "{name} covered everyone's shifts for years. The day he fell ill, there was no one for him." },
  ],
  artiste: [
    { fr: "{name} a tout vendu pour financer une toile entièrement blanche. Personne ne l'a comprise, lui non plus.", en: "{name} sold everything to fund an entirely blank canvas. Nobody understood it, himself included." },
  ...
  militaire: [
    { fr: "{name} a survécu à tout, sauf à la paperasse de sa retraite. Le dossier s'est perdu entre deux bureaux, et lui aussi.", en: "{name} survived everything but his own retirement paperwork. The file got lost between two offices, and so did he." },
    { fr: "{name} a monté la garde si longtemps qu'il en a oublié la raison. Quand il a demandé, plus personne ne s'en souvenait.", en: "{name} stood guard so long he forgot the reason. When he asked, no one else remembered either." },
    { fr: "{name} a suivi les ordres jusqu'au tout dernier. Le dernier ordre était de rentrer chez lui, mais il n'en avait plus.", en: "{name} followed orders down to the very last. The last order was to go home, but he no longer had one." },
  ],
  bibliothecaire: [
    { fr: "{name} connaissait chaque livre par cœur. La bibliothèque a fermé faute de lecteurs, et il en était le dernier.", en: "{name} knew every book by heart. The library closed for lack of readers, and he was the last one." },
    ...
    { fr: "{name} a rangé le dernier rayon avant de partir, comme chaque soir. On avait oublié de lui dire qu'il était licencié.", en: "{name} shelved the last row before leaving, like every night. They had forgotten to tell him he was let go." },
  ],
  vendeur: [
    { fr: "{name} pouvait vendre n'importe quoi à n'importe qui. Il s'est vendu à lui-même une voiture qu'il n'avait pas, et l'a payée.", en: "{name} could sell anything to anyone. He sold himself a car he didn't own, and paid for it." },
  ...
  jardinier: [
    ...
    { fr: "{name} a parlé à ses plantes pendant vingt ans. Le jour où elles ont semblé répondre, on est venu le chercher.", en: "{name} talked to his plants for twenty years. The day they seemed to answer, someone came to take him away." },
  ...
  avocat: [
    { fr: "{name} a gagné tous ses procès, sauf le sien. Il s'était choisi comme adversaire, par excès de confiance.", en: "{name} won every case but his own. He'd chosen himself as the opponent, out of overconfidence." },
    ...
    { fr: "{name} a plaidé si bien qu'il en a oublié de se faire payer. Ses clients, eux, n'ont rien oublié.", en: "{name} argued so well he forgot to get paid. His clients, however, forgot nothing." },
  ],
  musicien: [
    { fr: "{name} a attendu le grand concert pendant trente ans. Le soir venu, son harmonica s'est brisé sur la première note, et il n'a jamais rejoué depuis.", en: "{name} waited thirty years for the big concert. When the night came, his harmonica snapped on the first note, and he never played again." },
    ...
    { fr: "{name} a joué dans le métro jusqu'au dernier train, chaque soir. Un jour, le dernier train n'a plus voulu de lui.", en: "{name} played in the metro until the last train, every night. One day, the last train had no more room for him." },
  ],
  boxeur: [
    ...
    { fr: "{name} a encaissé mille coups sans broncher. Le seul qui l'a mis à terre, c'était un huissier, très poli.", en: "{name} took a thousand punches without flinching. The only one who put him down was a bailiff, very polite." },
  ...
  poete: [
    { fr: "{name} a écrit le plus beau vers de sa vie au dos d'un ticket. Il l'a rendu à la caissière par erreur, et le vers est parti avec la monnaie.", en: "{name} wrote the finest line of his life on the back of a receipt. He handed it to the cashier by mistake, and the line left with the change." },
...
const TRAIT_OPENERS: Record<string, Bilingual> = {
  ...
  poissard: { fr: "Poissard depuis toujours,", en: "Cursed with bad luck from birth," },
  'ami-pigeons': { fr: "Plus proche des pigeons que des gens,", en: "Closer to pigeons than to people," },
  'sommeil-plomb': { fr: "Dormeur de plomb,", en: "A dead-to-the-world sleeper," },
  ...
  paranoiaque: { fr: "Méfiant de tout et de tous,", en: "Suspicious of everyone," },
  'main-verte': { fr: "La main verte jusqu'au bout,", en: "Green-thumbed to a fault," },
  charismatique: { fr: "Charmeur invétéré,", en: "A born charmer," },
  'os-mousse': { fr: "Les os en mousse,", en: "With bones made of foam," },
  metabolisme: { fr: "Affamé en permanence,", en: "Forever hungry," },
  collectionneur: { fr: "Incapable de rien jeter,", en: "Unable to throw anything away," },
  'phobie-rats': { fr: "Terrorisé par les rats,", en: "Terrified of rats," },
  ...
  bricoleur: { fr: "Bricoleur dans l'âme,", en: "A tinkerer to the core," },
  orientation: { fr: "Jamais perdu nulle part,", en: "Never once lost," },
  'ventre-pattes': { fr: "Prêt à manger n'importe quoi,", en: "Willing to eat anything," },
};
...
export function generateOrigin(char: Character): OriginStory {
  ...
  return {
    ...
    textFr: fill((opener ? opener.fr + ' ' : '') + fall.fr),
    textEn: fill((opener ? opener.en + ' ' : '') + fall.en),
  };
}
